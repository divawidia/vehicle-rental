(function ($) {
	$.fn.niceNumber = function (options) {
		var defaults = {
			autoSize: true,
			autoSizeBuffer: 1,
			buttonDecrement: '<img src="/images/icons/minus.png" height="20px">',
			buttonIncrement: '<img src="/images/icons/plus.png" height="20px">',
		...
		return this.each(function () {
			...
			var $minusButton = $('<button/>')
				.attr('type', 'button')
                .attr('class', 'btn btn-outline-default mx-1 px-2')
