...
class VehicleBrandController extends Controller
{
                    ...
                    return '
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="' . route('brand.edit', $item->id) . '">Edit</a>
                                </li>
                                <li>
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vehicle-category-index')->with('status', 'Data Brand Kendaraan berhasil ditambahkan!');
    }
