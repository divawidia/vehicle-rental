...
@section('blog_images-custom-css')
    <link type="text/css" href="{{ asset('binshops-blog_images.css') }}" rel="stylesheet">
@endsection
...
@section('blog_images-custom-js')
    <script src="{{asset('binshops-blog_images.js')}}"></script>
@endsection
