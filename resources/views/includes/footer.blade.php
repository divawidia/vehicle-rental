        ...
        <div class="row g-custom-x">
            ...
            <div class="col-lg-3">
                <div class="widget">
                    ...
                    <address class="s1">
                  <span
                  ><i class="id-color fa fa-map-marker fa-lg"></i>Jl. Kayu
                    Aya, Gg, Beji No. 60x, Seminyak, Kec. Kuta, Kabupaten
                    Badung, Bali</span
                  >
                        <span
                        ><i class="id-color fa fa-phone fa-lg"></i>+62
                    822-3659-2085</span
                        >
                        <span
                        ><i class="id-color fa fa-envelope-o fa-lg"></i
                            ><a href="mailto:contact@example.com"
                            >batursarirental@gmail.com</a
                            ></span
                        >
                    </address>
                </div>
                ...
                <div class="col-md-12">
                    <div class="de-flex">
                        <div class="de-flex-col">
                            <a href="{{ route('home') }}">
                                Copyright 2023 - Bali Batur Rental
                            </a>
                        </div>
