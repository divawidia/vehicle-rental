<x-mail::message>
    ...
    <x-mail::subcopy>
        ...
        <p>Your motorbike rental booking has been confirmed.<br>
            Your rent booking has been confirmed and your payment has been successful.<br>
            Our customer service will contact you if there's some problem with your reservation<br><br>
