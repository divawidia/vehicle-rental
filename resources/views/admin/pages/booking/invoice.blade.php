                                ...
                                <div class="col-6">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-0">Jl. Kayu Aya, Gg, Beji No. 60x, Seminyak, Kec. Kuta, Kabupaten
                                            Badung, Bali</p>
                                        <p class="mb-0"><i class="mdi mdi-email-outline me-1"></i>info@batursarirental.com
                                        </p>
                        ...
                        <div class="py-2">
                            ...
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    <p class="text-muted mb-0">{{ $booking->vehicle->color }}
                                        , {{ $booking->vehicle->year }}</p>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="table-responsive mt-3">
                                ...
                                <hr class="my-1">
                                <p class="text-muted mb-0">*You will get free delivery charge if pick up and drop off
                                    route distance from our office are less than 5KM</p>
