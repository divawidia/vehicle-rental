                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" autocomplete="off" name="name" id="name" value="{{ $user->name }}" required>
                                        @error('name')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" autocomplete="off" name="email" id="email" value="{{ $user->email }}" required>
                                        @error('email')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control @error('password') is-invalid @enderror" type="password" autocomplete="off" name="password" id="password">
                                        @error('password')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" id="photo_url" name="photo_url" class="form-control" accept="image/*" value="{{ $user->photo_url }}"/>
                                        <img id="preview" class="rounded img-thumbnail mt-3" src="{{ Storage::url($user->photo_url ?? '') }}" alt="foto profile" style="display:none;"/>
                                        @error('photo_url')
                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
