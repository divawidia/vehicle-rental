                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" autocomplete="off" name="name" id="name" placeholder="Isikan nama diskon" value="{{ old('name') }}">
                                    @error('name')
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control @error('description') is-invalid @enderror" type="text" autocomplete="off" name="description" id="description" placeholder="Isikan deskripsi diskon" value="{{ old('description') }}">
                                    @error('description')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input class="form-control @error('discount_amount') is-invalid @enderror" type="number" autocomplete="off" name="discount_amount" id="discount_amount" placeholder="Isikan persentase diskon kendaraan" value="{{ old('discount_amount') }}">
