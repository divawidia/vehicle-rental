...
return [
    ...
    'blog_prefix' => "blog_images", // used in routes.php. If you want to your http://yoursite.com/latest-news (or anything else), then enter that here. Default: blog_images
    'admin_prefix' => "blog_admin", // similar to above, but used for the admin panel for the blog_images. Default: blog_admin

    'use_custom_view_files' => false, // set to false to disable the use of being able to make blog_images posts include a view from resources/views/custom_blog_posts/*.blade.php. Default: false. Set to true to use this feature. Default: false

    'per_page' => 10, // how many posts to show per page on the blog_images index page. Default: 10
    ...
    //if true it will echo out  (with {!! !!}) the blog_images post with NO escaping! This is not safe if you don't trust your blog_images post writers! Understand the risks by leaving this to true
    // (you should disable this (set to false) if you don't trust your blog_images writers).
    // This will apply to all posts (past and future).
    // Do not set to true if you don't trust your blog_images post writers. They could put in any HTML or JS code.
    ...
    // use the ckeditor WYWIWYG (rich text editor) for formatting your HTML blog_images posts.
    ...
    'comments' => [
        ...
        'max_num_of_comments_to_show' => 1000, // max num of comments to show on a single blog_images post. Set to a lower number for smaller page sizes. No comment pagination is built in yet.
